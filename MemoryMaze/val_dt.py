...
if config["model_mode"] == "RATE": 
    ...
    config['model_config']['skip_dec_ffn'] = False
...
ckpt_path = f'MemoryMaze/MemoryMaze_checkpoints/wo_filter/v2_DT/wo_filter_DT_arch_mode_TrXL_DT_RUN_1_2024_11_30_15_02_29/177750000_KTD.pth'
...
# ckpt_path = f'{parent_dir}/MemoryMaze/MemoryMaze_checkpoints/v3/DT/v3/DT_arch_mode_TrXL_DT_RUN_2_2024_09_26_05_19_54/32130000_KTD.pth'
# model.load_state_dict(torch.load(ckpt_path, map_location=device))
# model.to(device)
# _ = model.eval()
...
# ckpt_path = f'{parent_dir}/MemoryMaze/MemoryMaze_checkpoints/v3/DT/v3/DT_arch_mode_TrXL_DT_RUN_3_2024_09_26_07_32_15/24097500_KTD.pth'
# model.load_state_dict(torch.load(ckpt_path, map_location=device))
# model.to(device)
# _ = model.eval()
