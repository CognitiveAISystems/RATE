...
from oracle_dt_vizdoom.VizDoom_src.utils import z_normalize, inverse_z_normalize
from oracle_dt_vizdoom.VizDoom_src.utils import env_vizdoom2
...
env_args = {
    ...
    'limit_actions':True, 
    'scenario_dir':'oracle_dt_vizdoom/VizDoom_src/env/', 
    'test_scenario_dir':'', 
    'show_window':False, 
    'resize':True, 
    'multimaze':True, 
