...
def create_args():
    ...
    parser.add_argument('--exp-name',       type=str, default='doom', help='')
...
if __name__ == '__main__':
    ...
    run = wandb.init(project="RATE_DOOM_CQL", name=run_name, config=args, save_code=True)
    ...
    for epochs in tqdm(range(args.num_epochs), desc="Training epochs"):
        ...
        if epochs%10==0:
            PATH = f'offline_rl_baselines/ckpt/vizdoom_ckpt_mlp/{args.loss_mode}/{args.seed}/{run_name}'
