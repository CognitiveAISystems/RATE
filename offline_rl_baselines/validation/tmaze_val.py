...
if __name__ == '__main__':
    ...
    csv_path = f'{output_dir}/{exp_name}_{loss_mode}_{stacked_input}_{segments}_validation_results_changed_hidden.csv'
    ...
    for context_length in tqdm(
        ...
        for episode_timeout in tqdm(
            ...
            means = []
            ckpt_dir = f'offline_rl_baselines/ckpt/tmaze_ckpt_v2/{loss_mode}'
