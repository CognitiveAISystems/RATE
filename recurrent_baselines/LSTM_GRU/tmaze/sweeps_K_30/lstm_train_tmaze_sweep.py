...
from recurrent_baselines.LSTM_GRU.tmaze import lstm_trainer

# python3 recurrent_baselines/LSTM_GRU/tmaze/lstm_train_tmaze.py --model_mode 'LSTM' --curr 'true' --ckpt_folder 'LSTM_curr_max_3' --max_n_final 3 --text 'LSTM_curr'
...
with open("recurrent_baselines/LSTM_GRU/tmaze/config_lstm_K_30.yaml") as f:
...
if __name__ == '__main__':
    ...
    for RUN in range(start_seed, end_seed+1):
        ...
        ckpt_path = f'../{current_folder}/recurrent_baselines/LSTM_GRU/tmaze/ckpt/{ckpt_folder}/{name}/'
