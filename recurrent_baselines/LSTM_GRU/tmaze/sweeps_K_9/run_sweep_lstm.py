...
with open("recurrent_baselines/LSTM_GRU/tmaze/sweeps/sweep_config.yaml") as f:
...
def run_agent():
    subprocess.run(["python", "recurrent_baselines/LSTM_GRU/tmaze/sweeps/lstm_train_tmaze_sweep.py"])
