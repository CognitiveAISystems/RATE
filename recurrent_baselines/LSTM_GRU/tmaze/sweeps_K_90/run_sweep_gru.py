...
with open("recurrent_baselines/LSTM_GRU/tmaze/sweeps_K_90/sweep_config.yaml") as f:
...
def run_agent():
    subprocess.run(["python", "recurrent_baselines/LSTM_GRU/tmaze/sweeps_K_90/gru_train_tmaze_sweep.py"])
