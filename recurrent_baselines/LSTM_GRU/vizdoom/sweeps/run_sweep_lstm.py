...
with open("recurrent_baselines/LSTM_GRU/vizdoom/sweeps/sweep_config.yaml") as f:
...
def run_agent():
    subprocess.run(["python", "recurrent_baselines/LSTM_GRU/vizdoom/sweeps/lstm_train_vizdoom_sweep.py"])
