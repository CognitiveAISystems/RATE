...
with open("recurrent_baselines/Mamba/tmaze/sweeps_K_90/sweep_config.yaml") as f:
...
def run_agent():
    subprocess.run(["python", "recurrent_baselines/Mamba/tmaze/sweeps_K_90/mamba_train_tmaze_sweep.py"])
