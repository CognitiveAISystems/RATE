...
with open("recurrent_baselines/obs_only_LSTM_GRU/tmaze/sweeps_K_90/sweep_config.yaml") as f:
...
def run_agent():
    subprocess.run(["python", "recurrent_baselines/obs_only_LSTM_GRU/tmaze/sweeps_K_90/lstm_train_tmaze_sweep.py"])
