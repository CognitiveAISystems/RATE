...
from recurrent_baselines.obs_only_LSTM_GRU.vizdoom import lstm_trainer
...
# python3 recurrent_baselines/obs_only_LSTM_GRU/vizdoom/lstm_train_vizdoom.py --model_mode 'LSTM' --ckpt_folder 'LSTM' --text 'LSTM'
...
if __name__ == '__main__':
    ...
    for RUN in range(start_seed, end_seed+1):
        ...
        ckpt_path = f'../{current_folder}/recurrent_baselines/obs_only_LSTM_GRU/vizdoom/ckpt/{ckpt_folder}/{name}/'
