...
from recurrent_baselines.obs_only_Mamba.tmaze import mamba_trainer

# python3 recurrent_baselines/obs_only_Mamba/tmaze/mamba_train_tmaze.py --model_mode 'MAMBA' --curr 'false' --ckpt_folder 'MAMBA_max_3_no_curr' --max_n_final 3 --text 'MAMBA_max_3_no_curr'
...
with open("recurrent_baselines/obs_only_Mamba/tmaze/config_mamba_K_90.yaml") as f:
...
if __name__ == '__main__':
    ...
    for RUN in range(start_seed, end_seed+1):
        ...
        ckpt_path = f'../{current_folder}/recurrent_baselines/obs_only_Mamba/tmaze/ckpt/{ckpt_folder}/{name}/'
