...
python3 src/train.py \
    ...
    --wandb.wwandb=True \
    --data.gamma=1.0 \
    --data.path-to-dataset='data/MIKASA-Robo/unbatched/ChainOfColors3-v0' \
    ...
    --training.sections=1 \
    --model.env-name='mikasa_robo_ChainOfColors3-v0' \
    --model.state-dim=6 \
    --model.act-dim=8 \
    --model.d-model=64 \
    --model.dropout=0.0 \
    --model.padding-idx=None \
    --tensorboard-dir='runs/MIKASA_Robo/ChainOfColors3-v0' \
    --model-mode='BC' \
    --start-seed=1 \
    --end-seed=3 \
    --text='BC_MLP' \
