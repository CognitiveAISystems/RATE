...
python3 src/train.py \
    ...
    --wandb.wwandb=True \
    --data.gamma=1.0 \
    --data.path-to-dataset='data/MIKASA-Robo/unbatched/InterceptGrabFast-v0' \
    ...
    --training.sections=1 \
    --model.env-name='mikasa_robo_InterceptGrabFast-v0' \
    --model.state-dim=6 \
    --model.act-dim=8 \
    --model.d-model=128 \
    --model.dropout=0.0 \
    --model.padding-idx=None \
    --tensorboard-dir='runs/MIKASA_Robo/InterceptGrabFast-v0' \
    --model-mode='IQL' \
    --arch-mode='MLP' \
    --start-seed=1 \
    --end-seed=3 \
