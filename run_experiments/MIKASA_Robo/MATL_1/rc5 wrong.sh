...
python3 src/train.py \
    ...
    --dtype=float32 \
    --data.gamma=1 \
    --data.path-to-dataset="/workspace-SR006.nfs2/echerepanov/datasets/data_mikasa_robo/MIKASA-Robo/unbatched/RememberColor5-v0" \
    --model-mode=MATL \
    ...
    --model.env-name='mikasa_robo_RememberColor5-v0' \
    --model.n-head=2 \
    --model.n-layer=8 \
    ...
    --tensorboard-dir='runs/MIKASA_Robo/RememberColor5-v0' \
    --text='iclr-2025' \
