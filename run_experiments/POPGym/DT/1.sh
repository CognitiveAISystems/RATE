...
python3 src/train.py \
    ...
    --wandb.wwandb=True \
    --data.gamma=1.0 \
    --data.path-to-dataset='data/POPGym/popgym-AutoencodeHard-v0/' \
    --data.max-length=312 \
    ...
    --training.context-length=104 \
    --training.sections=1 \
    --model.env-name='popgym-AutoencodeHard' \
    --model.state-dim=-1 \
    --model.act-dim=4 \
    --model.n-layer=8 \
    --model.n-head=10 \
    ...
    --tensorboard-dir='runs/POPGym/AutoencodeHard-v0' \
    --model-mode='DT' \
    --arch-mode='TrXL' \
    --start-seed=1 \
    --end-seed=3 \
