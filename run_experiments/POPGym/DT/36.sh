...
python3 src/train.py \
    ...
    --wandb.wwandb=True \
    --data.gamma=1.0 \
    --data.path-to-dataset='data/POPGym/popgym-PositionOnlyPendulumEasy-v0/' \
    --data.max-length=201 \
    ...
    --training.sections=1 \
    --model.env-name='popgym-PositionOnlyPendulumEasy' \
    --model.state-dim=-1 \
    --model.act-dim=1 \
    --model.n-layer=8 \
    --model.n-head=10 \
    ...
    --tensorboard-dir='runs/POPGym/PositionOnlyPendulumEasy-v0' \
    --model-mode='DT' \
    --arch-mode='TrXL' \
    --start-seed=1 \
    --end-seed=3 \
