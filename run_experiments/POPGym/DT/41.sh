...
python3 src/train.py \
    ...
    --wandb.wwandb=True \
    --data.gamma=1.0 \
    --data.path-to-dataset='data/POPGym/popgym-RepeatFirstMedium-v0/' \
    --data.max-length=417 \
    ...
    --training.context-length=139 \
    --training.sections=1 \
    --model.env-name='popgym-RepeatFirstMedium' \
    --model.state-dim=-1 \
    --model.act-dim=4 \
    --model.n-layer=8 \
    --model.n-head=10 \
    ...
    --tensorboard-dir='runs/POPGym/RepeatFirstMedium-v0' \
    --model-mode='DT' \
    --arch-mode='TrXL' \
    --start-seed=1 \
    --end-seed=3 \
