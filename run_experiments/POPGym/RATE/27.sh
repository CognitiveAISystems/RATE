...
python3 src/train.py \
    ...
    --wandb.wwandb=True \
    --data.gamma=1.0 \
    --data.path-to-dataset='data/POPGym/popgym-NoisyPositionOnlyCartPoleEasy-v0/' \
    --data.max-length=198 \
    ...
    --training.context-length=66 \
    --training.sections=3 \
    --model.env-name='popgym-NoisyPositionOnlyCartPoleEasy' \
    --model.state-dim=-1 \
    --model.act-dim=2 \
    --model.n-layer=8 \
    --model.n-head=10 \
    ...
    --tensorboard-dir='runs/POPGym/NoisyPositionOnlyCartPoleEasy-v0' \
    --model-mode='RATE' \
    --arch-mode='TrXL' \
    --start-seed=1 \
    --end-seed=3 \
