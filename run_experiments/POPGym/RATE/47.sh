...
python3 src/train.py \
    ...
    --wandb.wwandb=True \
    --data.gamma=1.0 \
    --data.path-to-dataset='data/POPGym/popgym-VelocityOnlyCartpoleMedium-v0/' \
    --data.max-length=402 \
    ...
    --training.context-length=134 \
    --training.sections=3 \
    --model.env-name='popgym-VelocityOnlyCartpoleMedium' \
    --model.state-dim=-1 \
    --model.act-dim=2 \
    --model.n-layer=8 \
    --model.n-head=10 \
    ...
    --tensorboard-dir='runs/POPGym/VelocityOnlyCartpoleMedium-v0' \
    --model-mode='RATE' \
    --arch-mode='TrXL' \
    --start-seed=1 \
    --end-seed=3 \
