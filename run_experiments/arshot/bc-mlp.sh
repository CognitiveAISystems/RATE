...
# ARShot Environment Training Script for BC-MLP
# This script trains BC-MLP model on the ARShot associative retrieval task
...
python3 src/train.py \
    ...
    --model.backbone mlp \
    \
    --tensorboard-dir runs/ARShot/BC_MLP \
    --model-mode BC \
    --start-seed 1 \
    --end-seed 3 \
    --dtype "float32" \
